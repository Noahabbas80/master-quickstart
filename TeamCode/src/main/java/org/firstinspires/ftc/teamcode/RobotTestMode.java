...
@TeleOp(name = "RobotTestMode")


public class RobotTestMode extends LinearOpMode {
    public double SOA = 0;
    ...
    public void p2Controls(Gamepad currentGamepad2, Gamepad previousGamepad2) {
        switch (robotState) {
            case GRABSAMPLE:
                ...
                wristServo.setPosition(0.33 - .375 * gamepad2.left_stick_x); // write code to disable wrist while moving spinServo
