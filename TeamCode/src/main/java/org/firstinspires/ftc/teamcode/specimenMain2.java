...
@TeleOp(name = "specimenMain2")

public class specimenMain2 extends LinearOpMode {
    DcMotor frMotor, blMotor, flMotor, brMotor;
    Servo autoServo, clawServo, wristServo, alignServo, turretServo, armServo, pivotServo, outtakeServo,flipServo;
    ...
    armState robotState = armState.INTAKE;
